...
export default class VehicleCertificateGenerator {
    ...
    async initialize() {
        try {
            ...
            this.outerContainer = this.ElementGenerator.Generate(true, new HTMLComposedTags("div"), `certificate_fields_container`, ["certificate_fields_container"], [], this.outerContainerContainer);
    ...
    GenerateGeneratePdfButton() {
        this.generatePdfButton = this.ElementGenerator.Generate(true, new HTMLComposedTags("button"), `generate_pdf_button`, ["generate_pfd_button"], [["type", "button"]], this.outerContainerContainer, [], "Generar");
    ...
    collectFormData() {
        // const inputs = document.querySelector('input[name]');
